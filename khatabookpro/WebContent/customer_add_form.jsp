...
<p style="font-weight: bold;color:black; font-size: 30px; text-align: center; margin-bottom: 25px;margin-top:25px;">Add customers here:</p>
	...
	<table align="center" >
		...
		<tr>
			...
			<td>
				<input type="submit" style="color:white; background-color:#0000cc;padding:5px; margin-top:7px;" onclick="popUp()"
				 value="Add" >
			</td>
		</tr>
	</table>
